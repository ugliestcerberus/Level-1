public class Backpack {
	...
	public static void main (String[] args){
		...
		Backpack adidas= new Backpack();
		Textbook languageOfLiterature= new Textbook();
		Ruler wesCott= new Ruler();
		Pencil bic= new Pencil();
		Paper collegeRuled= new Paper();
		adidas.putInBackpack(languageOfLiterature);
		adidas.putInBackpack(bic);
		adidas.putInBackpack(wesCott);
		adidas.putInBackpack(collegeRuled);
		adidas.goToSchool();
	}
