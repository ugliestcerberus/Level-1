...
public class SimonSays extends KeyAdapter {
	...
	private void makeAlbum() {
		...
		images.put(new Integer(KeyEvent.VK_UP), "bkey.png");
		images.put(new Integer(KeyEvent.VK_DOWN), "deletekey.png");
		images.put(new Integer(KeyEvent.VK_LEFT), "enterkey.jpeg");
		images.put(new Integer(KeyEvent.VK_RIGHT), "escapekey.png");
		// 3. Tell the user to "Press the matching key when 'Simon says'
		// otherwise press a different key"
		JOptionPane.showMessageDialog(null,
				"Press the matching key when'Simon says ' otherwisse press a different key");
